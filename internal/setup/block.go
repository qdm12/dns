...
func BuildBlockBuilder(userSettings settings.Block,
	...
	settings.AllowedIPs = make([]netaddr.IP, len(userSettings.AllowedIPs))
	copy(settings.AllowedIPs, userSettings.AllowedIPs)

	settings.AllowedIPPrefixes = make([]netaddr.IPPrefix, len(userSettings.AllowedIPPrefixes))
	...
	settings.AddBlockedIPs = make([]netaddr.IP, len(userSettings.AddBlockedIPs))
	copy(settings.AddBlockedIPs, userSettings.AddBlockedIPs)

	settings.AddBlockedIPPrefixes = make([]netaddr.IPPrefix, len(userSettings.AddBlockedIPPrefixes))
