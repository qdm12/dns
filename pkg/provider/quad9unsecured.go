...
func Quad9Unsecured() Provider {
	return Provider{
		...
		Plain: PlainServer{
			IPv4: []netip.AddrPort{
				defaultPlainIPv4AddrPort([4]byte{9, 9, 9, 10}),
				defaultPlainIPv4AddrPort([4]byte{149, 112, 112, 10}),
			},
			IPv6: []netip.AddrPort{
				defaultPlainIPv6AddrPort([16]byte{0x26, 0x20, 0x0, 0xfe, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x10}),
				defaultPlainIPv6AddrPort([16]byte{0x26, 0x20, 0x0, 0xfe, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0xfe, 0x0, 0x10}),
			},
		},
		DoT: DoTServer{
			IPv4: []netip.AddrPort{
