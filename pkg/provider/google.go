...
func Google() Provider {
	return Provider{
		...
		Plain: PlainServer{
			IPv4: []netip.AddrPort{
				defaultPlainIPv4AddrPort([4]byte{8, 8, 8, 8}),
				defaultPlainIPv4AddrPort([4]byte{8, 8, 4, 4}),
			},
			IPv6: []netip.AddrPort{
				defaultPlainIPv6AddrPort([16]byte{0x20, 0x1, 0x48, 0x60, 0x48, 0x60, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x88, 0x88}),
				defaultPlainIPv6AddrPort([16]byte{0x20, 0x1, 0x48, 0x60, 0x48, 0x60, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x0, 0x88, 0x44}),
			},
		},
		DoT: DoTServer{
			IPv4: []netip.AddrPort{
