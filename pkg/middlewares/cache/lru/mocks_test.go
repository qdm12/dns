...
// Source: github.com/qdm12/dns/v2/pkg/middlewares/cache/lru (interfaces: Metrics)
//
// Generated by this command:
//
//	mockgen -destination=mocks_test.go -package lru . Metrics
//
...
func (m *MockMetrics) CacheMaxEntriesSet(maxEntries int) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "CacheMaxEntriesSet", maxEntries)
}

// CacheMaxEntriesSet indicates an expected call of CacheMaxEntriesSet.
func (mr *MockMetricsMockRecorder) CacheMaxEntriesSet(maxEntries any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CacheMaxEntriesSet", reflect.TypeOf((*MockMetrics)(nil).CacheMaxEntriesSet), maxEntries)
}
...
func (m *MockMetrics) SetCacheType(cacheType string) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "SetCacheType", cacheType)
}

// SetCacheType indicates an expected call of SetCacheType.
func (mr *MockMetricsMockRecorder) SetCacheType(cacheType any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "SetCacheType", reflect.TypeOf((*MockMetrics)(nil).SetCacheType), cacheType)
}
